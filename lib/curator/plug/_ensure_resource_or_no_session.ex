defmodule Curator.Plug.EEnsureResourceOrNoSession do
  @moduledoc """
  ...
  ## Example
      ...
      plug Curator.Plug.EnsureResourceOrNoSession, handler: SomeModule

      # look in the :secret location.
      plug Curator.Plug.EnsureResourceOrNoSession, handler: SomeModule, key: :secret
